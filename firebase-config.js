...
// 2. Clique em "Adicionar projeto" e crie o projeto (ex: contabilidade-apresentacao)
// 3. No menu lateral, clique em "Firestore Database" → Criar banco de dados → Modo de teste
// 4. No menu lateral, clique em "⚙ Configurações do projeto" → aba "Geral"
// 5. Em "Seus aplicativos", clique em "</>  Web" e registre o app
